<div class="col offset-s6 s3 right-align" id="menu">
	...
	<ul id="slide-out" class="side-nav side-menu center-align">
		...
		<li><a href="restaurant/edit_account.php"><i class="material-icons">mode_edit</i>Edit Account</a></li>
		<li><div class="divider"></div></li>
		<li><a href="change_password.php"><i class="material-icons">mode_edit</i>Password</a></li>
		<li><div class="divider"></div></li>
		<li><a href="restaurant/reservations_list.php"><i class="material-icons">format_list_numbered</i>Orders List</a></li>
		<li><div class="divider"></div></li>
