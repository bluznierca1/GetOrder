<div class="col offset-s6 s3 right-align" id="menu">
	...
	<ul id="slide-out" class="side-nav side-menu center-align">
		...
		<li><a href="user/login.php"><i class="material-icons">mode_edit</i>Edit account</a></li>
		<li><div class="divider"></div></li>
		<li><a href="user/register.php"><i class="material-icons">format_list_numbered</i>Orders List</a></li>
	  <li><div class="divider"></div></li>
	  <li><a href="restaurant/login.php"><i class="material-icons">help_outline</i>Need help?</a></li>
	  <li><div class="divider"></div></li>
